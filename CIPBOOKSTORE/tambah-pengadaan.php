        ...
        <div class="col-md-8 offset-md-2">
          <div class="card">
            <div class="card-header">
              TAMBAH PENGADAAN BUKU
            </div>
            <div class="card-body">
              <form action="prosestambah-pengadaan.php" method="POST">

                <div class="form-group">
                  <label>Judul Buku</label>
                  <input type="text" name="nama_buku" placeholder="Masukkan Judul Buku" class="form-control">
                </div>

                <div class="form-group">
                  <label>Stok</label>
                  <input type='number' required name="stok" placeholder="Masukkan Stok Buku" class="form-control">
                </div>
