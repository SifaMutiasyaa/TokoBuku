    ...
    <h1 class="logo me-auto"><a href="home.php"><marquee direction="right">Cipbookstore</marquee></a></h1>
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="active" href="pengadaan.php">PENGADAAN</a></li>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            ...
            <div class="card-body">
              <a href="tambah-pengadaan.php" class="btn btn-md btn-success" style="margin-bottom: 10px">TAMBAH DATA</a>
                ...
                <tbody>
                  ...
                  <tr>
                      ...
                      <td class="text-center">
                        <a href="edit-pengadaan.php?id=<?php echo $row['id_buku'] ?>" class="btn btn-sm btn-primary">EDIT</a>
                        <a href="hapus-pengadaan.php?id=<?php echo $row['id_buku'] ?>" class="btn btn-sm btn-danger">HAPUS</a>
                      </td>
                  </tr>
