<?php 
  ...
  include('koneksi.php');
  //menentukan data buku yang akan diambil dari database
  $id = $_GET['id']; //mengambil nilai id dan menyimpannya di variabel id
  //Membuat query SQL untuk mengambil data buku dari tabel berdasarkan nilai id
  $query = "SELECT * FROM tabel_buku WHERE id_buku = $id LIMIT 1"; //limit 1 untuk membatasi jumlah baris yang diambil
  $result = mysqli_query($connection, $query);
  $row = mysqli_fetch_array($result);
  //id_buku sesuai dengan nilai $id akan diambil dari tabel tabel_buku dalam database.
  //misalnya untuk menampilkan data buku dalam formulir edit.
  ?>
            ...
            <div class="card-body">
              <form action="proses-edit.php" method="POST">
                <div class="form-group">
                  ...
                  <select name="kategori" value="<?php echo $row['kategori'] ?>" class="form-control'">
                  <option>Novel</option>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  <label>Harga</label>
                  <input type="text" name="harga" value="<?php echo $row['harga'] ?>" placeholder="Masukkan Harga Buku" class="form-control">
                </div>

                <div class="form-group">
                  <label>Stok</label>
                  <input type="number" required name="stok" value="<?php echo $row['stok'] ?>" placeholder="Masukkan Stok Buku" class="form-control">
                </div>
